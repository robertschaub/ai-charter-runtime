...
continuation are completed separately in M5.12.
...
deletion propagation, live provider runs, and M6 capture. The two non-blocking M5.10 transaction-shape hardening
observations remain separately deferred rather than being hidden inside this slice.
